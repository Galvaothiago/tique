...
export function BetResult() {
    ...
    return (
        <section className="w-full h-52 bg-green-50" >
            <p className="w-full text-center text-xs text-slate-500 border-b py-2 border-slave">resultado</p>
            <div className="flex justify-center items-center gap-1 pt-6">
               { fakeResult.map( number => 
                <span className="grid place-items-center text-white text-3xl font-bold w-14 h-20 rounded-lg bg-green-300" >{number}</span>) }
            </div>
