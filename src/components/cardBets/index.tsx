...
export function CardBets({ quantity, date }: CardBetsProps) {
    ...
    return (
        <div className="max-w-sm h-14 w-full flex items-center justify-between bg-gradient-to-l from-slate-100 to-green-300 pl-6 pr-2 rounded-l-full cursor-pointer">
