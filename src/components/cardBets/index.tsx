...
export function CardBets({ quantity, date }: CardBetsProps) {
    ...
    return (
        <div className="max-w-sm w-full h-full flex items-center justify-between bg-gradient-to-l from-slate-100 to-green-300 pl-6 pr-2 rounded-l-full cursor-pointer">
            <p className="text-slate-700 text-sm font-bold">{`#${formatDate}`}</p>
