...
export function CheckResult() {
    ...
    const TIME_CLOSE_AUTOMATICALLY = 20000
        ...
        <div className="flex flex-col w-full h-96 bg-green-100">
            ...
            { showButtonsDelete ? 
                ( !showSingleButtonDelete ? <div className="flex justify-center gap-2 w-full pb-2">
                    <button className="w-44 p-2 bg-red-400 text-slate-200 rounded-md">excluir todos</button>
            ...
            <div className="w-full h-full overflow-y-auto p-8">
                <div className="flex flex-col items-center gap-3 w-full h-auto py-4">
