                    ...
                    <form action="#" >
                        <div className="flex flex-col mb-2">
                            <div className="relative">
                                <input
                                    ...
                                    className={`rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 ${ feedbackEmail ? 'focus:ring-red-800' : 'focus:ring-green-500'} focus:border-transparent`} name="email" placeholder="Email"/>
                        ...
                        <div className="flex flex-col mb-2 mt-4">
                            <div className="relative mb-2">
                                <input
                                    ...
                                    className={` rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 ${ feedbackPassword ? 'focus:ring-red-800' : 'focus:ring-green-500'} focus:border-transparent`} placeholder="Senha"/>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className={`rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 ${ !feedbackConfirmPassword ? 'focus:ring-red-800' : 'focus:ring-green-500'} focus:border-transparent`} placeholder="Repita a senha"/>
                            </div>
                        </div>
                        <div className="flex item-center">
                                <button
                                    ...
                                    className={`py-3 px-4 mt-4 flex justify-center ${ !checkInformationBeforeSend() && 'cursor-not-allowed'} items-center bg-slate-100 hover:bg-slate-200 focus:ring-slate-50 focus:ring-offset-slate-50 transition ease-in duration-200 text-slate-600 w-full text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg`}>
